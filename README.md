...
:warning: With this tool you can download Exchange Server 2016 on a Windows Server 2016 and Exchange Server 2019 on a Windows Server 2019.
...
:warning: After that you will have to install **`without reboot`,  (Net Framework 4.8, Visual C++, API)**

<img src="images/Net-Framwork.png">

:warning: I recommend that when you go to download the dependencies and copy the link that you deactivate it so that it lets you download it quietly.
